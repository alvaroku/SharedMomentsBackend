...
namespace SharedMomentsBackend.App.DB.Migrations
{
    ...
    [Migration("20240809021045_InitialCreate")]
            ...
            modelBuilder.Entity("SharedMomentsBackend.App.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fabfb63b-9ea6-44aa-85ea-4fe0de75b134"),
                            CreatedAt = new DateTime(2024, 8, 9, 2, 10, 45, 235, DateTimeKind.Utc).AddTicks(113),
                            IsActive = true,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2024, 8, 9, 2, 10, 45, 235, DateTimeKind.Utc).AddTicks(119)
                        },
                        new
                        {
                            Id = new Guid("e9a54e41-3d9a-4a93-abb5-a3652846edc2"),
                            CreatedAt = new DateTime(2024, 8, 9, 2, 10, 45, 235, DateTimeKind.Utc).AddTicks(122),
                            IsActive = true,
                            Name = "User",
                            UpdatedAt = new DateTime(2024, 8, 9, 2, 10, 45, 235, DateTimeKind.Utc).AddTicks(122)
                        });
                });
            ...
            modelBuilder.Entity("SharedMomentsBackend.App.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("27a4b889-3192-4f14-86ca-eebd3e9561b6"),
                            CreatedAt = new DateTime(2024, 8, 9, 2, 10, 45, 235, DateTimeKind.Utc).AddTicks(305),
                            ...
                            RoleId = new Guid("fabfb63b-9ea6-44aa-85ea-4fe0de75b134"),
                            UpdatedAt = new DateTime(2024, 8, 9, 2, 10, 45, 235, DateTimeKind.Utc).AddTicks(306)
                        });
                });
